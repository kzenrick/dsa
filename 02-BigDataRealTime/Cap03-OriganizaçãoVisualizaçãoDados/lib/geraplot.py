...
def make_autos_mpg_plot(figure, gs = None, pddata = None, axes = None):
    ...
    # Teste Vitorino
    labels = geradados.get_make_labels(pddata)
    lista_aux = [" "] * (12 - len(labels))
    axes.set_xticklabels(labels + lista_aux)
    # Fim Teste Vitorino
...
def make_autos_riskiness_plot(
    ...
    if labels:
        ...
        axes.set_xticklabels(lista_aux + labels)
        # Fim Teste Vitorino
