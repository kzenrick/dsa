                ...
                dbc.Col([
                    ...
                    dbc.Nav(
                        [
                            ...
                            dbc.NavItem(dbc.NavLink("Help", href = "/paginas/help"), style=constant.NAVITEM_STYLE),
                            dbc.NavItem(dbc.NavLink("Configurações", href = "/paginas/settings"), className = "p-3 align-bottom", style = {'margin-top': '100%'})
                        ], 
                        className = "h-100", 
                        navbar = True,
                        pills = True,
