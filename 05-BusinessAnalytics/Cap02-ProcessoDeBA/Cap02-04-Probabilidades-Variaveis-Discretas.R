...
setwd("~/Documentos/dsa/05-Business Analytics/Cap02-ProcessoDeBA")
getwd()
...
# dbinom é uma função de massa de probabilidade da distribuição binomial, enquanto  --> Probabilidade
# pbinom é uma função de distribuição cumulativa dessa distribuição.                --> Probabilidade Acumulativa

# O primeiro diz a você o que é P (X𝑋 =x 𝑥) (probabilidade de observar valor igual a 𝑥)
# enquanto o segundo, o que é P (X𝑋≤x𝑥) (probabilidade de observar valor menor ou igual a 𝑥)
