...
setwd("~/Documentos/dsa/05-Business Analytics/Cap03-Analytics-II")
getwd()
...
## Verificando correlação das variáveis - apenas curiosidade
corrplot(cor(mtcars[,seq(1: 11)]), method = "circle")
